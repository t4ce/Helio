...
pub struct SkyContext {
    ...
    /// Skip the atmosphere's below-horizon ground/haze response.
    pub disable_below_horizon: bool,
    /// Leave sky radiance linear for the normal post-process tonemap.
    pub disable_pre_tonemap: bool,
}
...
impl SkyActor {
    ...
    pub fn without_below_horizon(mut self) -> Self {
        self.context.disable_below_horizon = true;
        self
    }

    pub fn without_pre_tonemap(mut self) -> Self {
        self.context.disable_pre_tonemap = true;
        self
    }
...
impl Default for SkyContext {
    fn default() -> Self {
        Self {
            ...
            clouds: None,
            disable_below_horizon: false,
            disable_pre_tonemap: false,
        }
    }
}
