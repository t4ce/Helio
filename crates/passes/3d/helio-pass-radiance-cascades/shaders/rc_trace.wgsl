...
// Canonical 128-byte authored layout. Offset 48 is a request flag until the
// compact projection overlays Helio's assigned shadow slice.
struct GpuLight {
    ...
    god_rays_enabled: u32, god_rays_density: f32, god_rays_weight: f32,
    god_rays_decay: f32, god_rays_exposure: f32,
    flare_enabled: u32, flare_type: u32, flare_intensity: f32, flare_scale: f32,
    flare_tint_r: f32, flare_tint_g: f32, flare_tint_b: f32,
    ies_profile_index: i32, light_function_index: i32,
    ies_angle_scale: f32, ies_angle_offset: f32,
}
...
fn eval_light(li: u32, hit_pos: vec3<f32>, hit_normal: vec3<f32>) -> vec3<f32> {
    ...
    return light.color_intensity.xyz * light.color_intensity.w * atten * ndotl * vis;
}
