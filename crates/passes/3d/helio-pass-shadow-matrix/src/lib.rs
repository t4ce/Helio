        ...
        if self.bind_group_key != Some(key) {
            self.bind_group = Some(ctx.device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    ...
                    wgpu::BindGroupEntry { binding: 1, resource: ctx.scene.shadow_matrices.as_entire_binding() },
                    ...
                    wgpu::BindGroupEntry { binding: 4, resource: self.shadow_dirty_buf.as_entire_binding() },
                    wgpu::BindGroupEntry { binding: 5, resource: self.shadow_hashes_buf.as_entire_binding() },
                    wgpu::BindGroupEntry { binding: 6, resource: ctx.scene.light_projections.as_entire_binding() },
                ],
            }));
