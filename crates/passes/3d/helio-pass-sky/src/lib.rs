...
impl ShaderSkyUniforms {
    fn earth_like() -> Self {
        ...
        Self {
            ...
            disable_below_horizon: 0,
            disable_pre_tonemap: 0,
            _pad2: 0.0,
        }
    }
}
...
impl RenderPass for SkyPass {
    ...
    fn prepare(&mut self, ctx: &PrepareContext) -> HelioResult<()> {
        ...
        uniforms.disable_below_horizon = ctx.frame_resources.sky.disable_below_horizon as u32;
        uniforms.disable_pre_tonemap = ctx.frame_resources.sky.disable_pre_tonemap as u32;
